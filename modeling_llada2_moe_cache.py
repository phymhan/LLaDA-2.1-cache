    ...
    def forward(
        ...
        **kwargs,
        ...
        if past_key_value is not None:
            ...
            if store_kv is not False:
                # store_kv=True or store_kv=None (original behavior): store KV in cache
                cache_kwargs = {"sin": sin, "cos": cos}
                key_states, value_states = past_key_value.update(
                    key_states, value_states, self.layer_idx, cache_kwargs
                )
            else:
                # store_kv=False: retrieve past KV and concatenate, but don't store
        ...
        **kwargs,
        ...
        Args:
            ...
            store_kv (`bool`, *optional*):
                If True, store KV in cache. If False, retrieve past KV but don't store.
                If None, use original behavior (always store when cache is present).
        """
